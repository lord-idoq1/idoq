...
router.get('/socialmedia/tiktoknowm', async (req, res, next) => {    
     ...
     if (!url) return res.json(loghandler.noturl)
     if(listkey.includes(apikey)){
fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/tiktoknowm?url=${url}&apikey=ojan`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/socialmedia/tiktokwm', async (req, res, next) => {    
     ...
     if (!url) return res.json(loghandler.noturl)
     if(listkey.includes(apikey)){
fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/tiktokwithwm?url=${url}&apikey=ojan`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({       
...
router.get('/stalk/ig', async (req, res, next) => {   
     ...
     if (!username) return res.json(loghandler.notusername)
     if(listkey.includes(apikey)){
fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/igstalk?username=${username}&apikey=ojan`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({             
