...
router.get('/socialmedia/snapsavee', async (req, res, next) => {    
     ...
     if (!url) return res.json(loghandler.noturl)
fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/snapsave?url=${url}&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/socialmedia/tiktokdl', async (req, res, next) => {    
     ...
     if (!url) return res.json(loghandler.noturl)
fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/tiktokdownloader?url=${url}&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({ 
...
router.get('/socialmedia/ddtik', async (req, res, next) => {   
     ...
     if (!url) return res.json(loghandler.noturl)
fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/dddtik?url=${url}&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/socialmedia/ttmate', async (req, res, next) => {    
     ...
     if (!url) return res.json(loghandler.noturl)
fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/tikmate?url=${url}&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({  
...
router.get('/socialmedia/ttsave', async (req, res, next) => {   
     ...
     if (!url) return res.json(loghandler.noturl)
fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/ttsave?url=${url}&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({ 
...
router.get('/socialmedia/snaptik', async (req, res, next) => {    
     ...
     if (!url) return res.json(loghandler.noturl)
fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/nguteksnaptik?url=${url}&apikey=idoganz`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({             
...
router.get('/socialmedia/mediafire', async (req, res, next) => {   
     ...
     if (!url) return res.json(loghandler.noturl)
fetch(encodeURI(`https://api.dapuhy.ga/api/socialmedia/mediafire?url=${url}&apikey=idoganz`))
then(response => response.json())
        .then(data => {
        var result = data;
             res.json({      
...
router.get('/igdl', async(req, res) => {
      ...
      router.get('/fbdl', async(req, res) => {
	     let url = req.query.url
	     if (!url) return res.json(loghandler.noturl)
	     let result = await hxz.fbdown(url)
	     try {
	     res.json({
			  status: 200,
			  creator: `${creator}`,
...
router.get('/tiktok2', async(req, res, next) => {
  const url = req.query.url;
